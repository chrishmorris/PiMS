...
public class UserGroupBean extends ModelObjectShortBean {
    ...
    private final Collection<ModelObjectShortBean> members;
    ...
    public UserGroupBean(final UserGroup group, final boolean immutable) {
        ...
        final Set groupMembers = group.getMemberUsers();
        final Set mem = new HashSet();
        final Iterator i = groupMembers.iterator();
        while (i.hasNext()) {
            final User u = (User) i.next();
            mem.add(new ModelObjectBean(u));
        }
        this.members = mem;
    }
    ...
    public UserGroupBean(final UserGroup group, final Collection<String> parms) {
        ...
        while (i.hasNext()) {
            final User u = (User) i.next();
            mem.add(new ModelObjectShortBean(u));
        }
        this.members = mem;
    }
     ...
     */
    public Collection<ModelObjectShortBean> getMembers() {
        return this.members;
    }
