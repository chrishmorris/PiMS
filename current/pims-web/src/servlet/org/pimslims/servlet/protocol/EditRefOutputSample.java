...
import org.pimslims.presentation.protocol.RefOutputSampleBean;
 ...
 * 
 */
public class EditRefOutputSample extends
/* common servlet that provides utility methods */PIMSServlet {
    ...
    public String getServletInfo() {
        return "Forwards to an edit page for the RefOutputSample";
    }
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        if (null == pathInfo || 1 >= pathInfo.length()) {
            this.writeErrorHead(request, response, "No ref output sample specified",
        ...
        try {
            ...
            if (null != pathInfo) {
                ros = version.get(pathInfo); // e.g.
                // Example/org.pimslims.model.experiment.Experiment:42355
                if (null == ros) {
                    this.writeErrorHead(request, response, "No such RefOutputSample: " + pathInfo,
            ...
            request.setAttribute("bean", new RefOutputSampleBean(ros));
            request.setAttribute("protocol", new ProtocolBean(ros.getProtocol()));

            final RequestDispatcher dispatcher =
                request.getRequestDispatcher("/JSP/protocol/CreateEditRefOutputSample.jsp");
