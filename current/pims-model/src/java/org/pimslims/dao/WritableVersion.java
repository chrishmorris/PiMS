...
public interface WritableVersion extends ReadableVersion {
     ...
     */
    public <T extends ModelObject> T create(Class<T> javaClass, java.util.Map<String, Object> attributes)
     ...
     * @throws ConstraintException
     */
    public <T extends ModelObject> T create(String owner, Class<T> javaClass,
        java.util.Map<String, Object> attributes) throws AccessException, ConstraintException;
     ...
     */
    public <T extends ModelObject> void delete(java.util.Collection<T> objects) throws AccessException,
        ConstraintException;
     ...
     * @param owner current user's usual owner setting when creating an object
     */
    public void setDefaultOwner(LabNotebook owner);
     ...
     * @throws IOException
     */
    public abstract File createFile(InputStream inputStream, String name, LabBookEntry parent)
     ...
     * @throws IOException
     */
    public abstract File createFile(byte[] data, String name, LabBookEntry parent) throws AccessException,
    ...
    /**
     * get the default access object
     * 
     * @return the default access object
     */
    public org.pimslims.model.core.LabNotebook getCurrentDefaultOwner();

    /**
     * WritableVersion.clear Clears caches, for use when testing
     */
    public void clear();

    /**
     * WritableVersion.setFlushModeCommit Improves performance for inserts, but makes newly created objects
