/*
 * Created on 02-Aug-2004 @author: Chris Morris
 */
 ...
 */
public interface MetaClass extends MetaElement {
     ...
     */
    public <T extends ModelObject> T create(final WritableVersion version, final String owner,
    ...
    /**
     * @return the attributeName for default order
     */
    public Map<String, Order> getOrderBy();

    /**
     * @return the role names for join during search
     */
