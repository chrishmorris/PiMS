 ...
 * @author ian
 */
public class OrExpression extends BusinessCriterion {
    private final BusinessCriterion criteria1;
    private final BusinessCriterion criteria2;

    public OrExpression(String property, BusinessCriterion criteria1, BusinessCriterion criteria2) {
        super(property);
    ...
    public String formatClause() {
       return "(" + criteria1.formatClause() + " OR " + criteria2.formatClause() + ")";
     }
}
