 ...
 */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected uk.ac.ox.oppf.www.wsplate.ArrayProperty localProperties ;
                                

                           /**
                           * Auto generated getter method
                           * @return uk.ac.ox.oppf.www.wsplate.ArrayProperty
                           */
                           public  uk.ac.ox.oppf.www.wsplate.ArrayProperty getProperties(){
                            ...
                            /**
                               ...
                               */
                               public void setProperties(uk.ac.ox.oppf.www.wsplate.ArrayProperty param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       CaptureProfile.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CaptureProfile",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CaptureProfile",
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"profileID", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"profileID");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("profileID");
                                    }
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localProperties.serialize(new javax.xml.namespace.QName("","properties"),
                                               factory,xmlWriter);
    ...
    public static class Factory{
        ...
        */
        public static CaptureProfile parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CaptureProfile".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CaptureProfile)uk.ac.ox.oppf.www.wsplate.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","properties").equals(reader.getName())){
                                                ...
                                                object.setProperties(uk.ac.ox.oppf.www.wsplate.ArrayProperty.Factory.parse(reader));
