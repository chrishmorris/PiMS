 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ImagingTask.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localState));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                         ...
                                         elementList.add(localDateImaged==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDateImaged));
    ...
    public static class Factory{
        ...
        */
        public static ImagingTask parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ImagingTask object =
                new ImagingTask();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ImagingTask".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ImagingTask)uk.ac.ox.oppf.www.wsplate.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
