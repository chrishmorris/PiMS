...
namespace OPPF.Integrations.ImagerLink.Scheduling
{
	...
	public class ImagingTaskProviderNew : IImagingTaskProvider
	{
		...
		/// </summary>
        private static readonly string PLATEDB_CONNECTION_STRING = "driver={PostgreSQL Unicode};Server=172.22.20.7;Database=xpims410;UID=pimsupdate;PWD=XXXXXX;";
