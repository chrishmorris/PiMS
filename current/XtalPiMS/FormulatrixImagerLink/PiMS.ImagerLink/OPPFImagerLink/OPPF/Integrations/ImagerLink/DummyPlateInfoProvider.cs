...
namespace OPPF.Integrations.ImagerLink
{
    ...
    /// </remarks>
    public class DummyPlateInfoProvider : IPlateInfoProvider
    {
        ...
        /// PlateInfo cache
        /// </summary>
        private readonly DummyPlateInfoCache _plateInfoCache;

        /// <summary>
        /// Zero-arg constructor
        /// </summary>
        public DummyPlateInfoProvider()
        {
            ...
            _plateInfoCache = new DummyPlateInfoCache(1000, 1000);
