...
<c:set var="HeaderName" scope="page" value="View Constructs" />
...
<h3>Browse Constructs</h3>
<a href="${pageContext.request['contextPath']}/Create/org.pimslims.model.target.ResearchObjective">Create New Construct</a>
...
PIMS.xtal.sessionBookmarkConstructs = '<%=(null != request.getSession().getAttribute("constructsDataTable")) ? request.getSession().getAttribute("constructsDataTable") : "" %>';
PIMS.xtal.onDOMReady(PIMS.xtal.initViewConstructs);
</script>
