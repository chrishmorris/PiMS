...
PIMS.xtal.FilteredTable.handlers.rowClickViewConditions = function (oArgs) {
	...
	if (name) {
		window.location.href = contextPath + "/EditScreen/" + name;
	}
};
...
PIMS.xtal.initHome = function () {
	...
	dfA = new PIMS.xtal.DataFilter({results: 4, startDate: weekago, sort: "date", dir: "desc", sb: "h_a"});
	...
	dfI = new PIMS.xtal.DataFilter({results: 4, inspectionStartDate: weekago, sort: "date", dir: "desc", sb: "h_i"});
