...
<pimsWidget:box initialState="open" title="Files">
		...
		<table>
			...
			<c:forEach items="${annotations}" var="file">
	      		<tr id="${file._Hook}" class="ajax_deletable">
		        	...
		        	<td>
			        	<a href="${pageContext.request.contextPath}/read/ViewFile/${file._Hook}/${file.name}" title="view file" target="file">
	...
	<hr/>
	<pimsForm:form mode="create" action="/update/ListFiles/${group._Hook}" method="post" enctype="multipart/form-data" >
		<c:choose>
