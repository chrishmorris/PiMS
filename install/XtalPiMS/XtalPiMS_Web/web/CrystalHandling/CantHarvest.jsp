...
<p>You need to be logged in as a user with "create" permissions in at least one PiMS lab notebook. View-only accounts are 
allowed to view crystal images but not crystal harvesting and treatment; if you are using a view-only account, you need 
