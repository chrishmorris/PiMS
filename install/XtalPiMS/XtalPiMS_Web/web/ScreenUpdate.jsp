...
<pimsWidget:box title="Screen details" initialState="fixed">
 <pimsForm:form method="post" action="/EditScreen/${screen.name}" mode="edit" id="new_plate">
   <pimsForm:formBlock>
         <pimsForm:column1>
     ...
     <pimsForm:textarea name="description" alias="Description">${screen.details}</pimsForm:textarea> 
                     ...
                     <td>                       
                        <c:choose>
                            ...
                            <c:forEach var="component" items="${conditions[current].components}">
                                  ${component.componentName} (${component.quantity})<br/>
                            </c:forEach>
                            </c:when><c:otherwise>
                                [None]
                            </c:otherwise>
