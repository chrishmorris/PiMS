...
<c:set var="HeaderName" scope="page" value="Upload New Order" />
<%@include file="./WEB-INF/jspf/header-min.jspf"%>
<%-- HTML STARTS HERE --%>

   
<pimsWidget:box title="Upload Order" initialState="fixed">
<pimsForm:form method="post" enctype="multipart/form-data" action="/OrderUpload" mode="edit" >
   <pimsForm:formBlock>
         <pimsForm:column1>
         Upload order XML file to create new order for cystallization screening of a protein sample.
