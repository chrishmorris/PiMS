...
<link rel="shortcut icon" href="${pageContext.request['contextPath']}/xtal/images/faviconxp.png" />
	...
	<!--  TODO why not <script type="text/javascript" src="${pageContext.request.contextPath}/javascript/prototype/prototype-1.6.0.2.js" ></script> -->
...
<div id="tcplayer" style="text-align:right">
	...
	/><input type="button" name="tcdelayup" id="tcdelayup" value="+" />
			...
			<div id="fulltimecourse">
				<img src="${pageContext.request['contextPath']}/images/icons/actions/waiting.gif" />
			</div>
		</div>
	</div>
</div>
