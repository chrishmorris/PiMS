	...
	protected void processRequest(final HttpServletRequest request,
		...
		try {
			...
			if ((finalPH != null) && (!finalPH.equals(""))) {
				...
				crp.getSessionBookmark().put(ConditionView.PROP_FINAL_PH,
						finalPH);
			}
			...
			if ((well != null) && (!well.equals(""))) {
				criteria.add(BusinessExpression.Like(ConditionView.PROP_WELL,
						well, true, true));
				crp.getSessionBookmark().put(ConditionView.PROP_WELL, well);
			}
			if ((componentsName != null) && (!componentsName.equals(""))) {
				...
				crp.getSessionBookmark().put("componentName", componentsName);
			}
