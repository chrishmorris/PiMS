	...
	protected void processRequest(final HttpServletRequest request,
		...
		try {
			...
			if ((id != null) && (!id.equals(""))) {
				...
				crp.getSessionBookmark().put(SampleView.PROP_ID, id);
			}
			...
			if ((name != null) && (!name.equals(""))) {
				criteria.add(BusinessExpression.Like(SampleView.PROP_NAME,
						name, true, true));
				crp.getSessionBookmark().put(SampleView.PROP_NAME, name);
			}
			...
			if ((minMolecularWeight != null)
				...
				crp.getSessionBookmark().put("minMolecularWeight",
						minMolecularWeight);
				crp.getSessionBookmark().put("maxMolecularWeight",
						maxMolecularWeight);
			}
			// TODO Deal with min and max separately
			if ((minConcentration != null) && (!minConcentration.equals(""))
				...
				crp.getSessionBookmark().put("minConcentration",
						minConcentration);
				crp.getSessionBookmark().put("maxConcentration",
						maxConcentration);
			}
			// TODO Deal with min and max separately
			if ((minPH != null) && (!minPH.equals("")) && (maxPH != null)
				...
				crp.getSessionBookmark().put("minPH", minPH);
				crp.getSessionBookmark().put("maxPH", maxPH);
			}
			// TODO Deal with min and max separately
			if ((minNumSubUnits != null) && (!minNumSubUnits.equals(""))
				...
				crp.getSessionBookmark().put("minNumSubUnits", minNumSubUnits);
				crp.getSessionBookmark().put("maxNumSubUnits", maxNumSubUnits);
			}
