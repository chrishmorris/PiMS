	...
	protected void processRequest(HttpServletRequest request,
		...
		try {
			...
			if ((priority != null) && (!priority.equals(""))
				...
				crp.getSessionBookmark().put(ScheduleView.PROP_PRIORITY,
						priority);
			}
			if ((state != null) && (!state.equals(""))
				...
				criteria.add(BusinessExpression.Like(ScheduleView.PROP_STATE,
						state, true, true));
				crp.getSessionBookmark().put(ScheduleView.PROP_STATE, state);
			}
			if ((temperature != null) && (!temperature.equals(""))) {
				try {
					...
					crp.getSessionBookmark().put(ScheduleView.PROP_TEMPERATURE,
							temperature);
			...
			if ((dateToImage != null) && (!dateToImage.equals(""))
				...
				try {
					...
					crp.getSessionBookmark().put("dateToImage", dateToImage);
