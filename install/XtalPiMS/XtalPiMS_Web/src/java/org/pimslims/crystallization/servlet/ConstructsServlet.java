		...
		try {
			...
			if ((constructId != null) && (!constructId.equals(""))) {
				...
				crp.getSessionBookmark()
						.put(ConstructView.PROP_ID, constructId);
			}
			if ((constructName != null) && (!constructName.equals(""))) {
				...
				crp.getSessionBookmark().put(ConstructView.PROP_NAME,
						constructName);
			}
			if ((description != null) && (!description.equals(""))) {
				criteria.add(BusinessExpression
						.Like(ConstructView.PROP_DESCRIPTION, description,
								true, true));
				crp.getSessionBookmark().put(ConstructView.PROP_DESCRIPTION,
						description);
			}
			if ((owner != null) && (!owner.equals(""))) {
				criteria.add(BusinessExpression.Like(ConstructView.PROP_OWNER,
						owner, true, true));
				crp.getSessionBookmark().put(ConstructView.PROP_OWNER, owner);
			}
			if ((group != null) && (!group.equals(""))) {
				criteria.add(BusinessExpression.Like(ConstructView.PROP_GROUP,
						group, true, true));
				crp.getSessionBookmark().put(ConstructView.PROP_GROUP, group);
			}
