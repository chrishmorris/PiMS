		...
		try {
			...
			if ((name != null) && (!name.equals(""))) {
				criteria.add(BusinessExpression.Like(ScreenView.PROP_NAME,
						name, true, true));
				crp.getSessionBookmark().put(ScreenView.PROP_NAME, name);
			}
			if ((manufacturerName != null) && (!manufacturerName.equals("all"))) {
				criteria.add(BusinessExpression.Like(
						...
						true, true));
				crp.getSessionBookmark().put(ScreenView.PROP_MANUFACTURER_NAME,
						manufacturerName);
			} else {
				crp.getSessionBookmark().put(ScreenView.PROP_MANUFACTURER_NAME,
						"all");
			...
			if ((type != null) && (!type.equals("all"))) {
				criteria.add(BusinessExpression.Equals(ScreenView.PROP_TYPE,
						type, true));
				crp.getSessionBookmark().put(ScreenView.PROP_TYPE, type);
			} else {
				crp.getSessionBookmark().put(ScreenView.PROP_TYPE, "all");
			}
