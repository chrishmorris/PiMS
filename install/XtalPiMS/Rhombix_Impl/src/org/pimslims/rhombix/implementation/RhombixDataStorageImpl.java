/**
 * Rhombix_Impl org.pimslims.rhombix DataStorageImpl.java
 * 
 * @author cm65
 * @date 12 Jan 2011
 * 
 ...
 * 
 */
public class RhombixDataStorageImpl implements DataStorage {

    RhombixConnection connection;
     ...
     * @param version TODO
     */
    public RhombixDataStorageImpl(boolean readOnly, RhombixVersion version) {
        super();
    ...
    public ImagerService getImagerService() {
        return new ImagerServiceImpl(this.connection);
    }
    ...
    public LocationService getLocationService() {
        return new LocationServiceImpl(this.connection);
    }
    ...
    public void openResources(String username) throws BusinessException {
        this.connection = new RhombixConnectionImpl(this.readOnly);
        this.beginTransaction();
        System.out.println("Connected to Rhombix");
    }
    ...
    static void insert(String tableName, String keyName, RhombixConnection rhombixConnection, String value) {
        try {
            RhombixPreparedStatement statement =
                rhombixConnection.prepareStatement("insert into " + tableName + " (" + tableName + "_id,"
                    + keyName + ") values (" + tableName + "_seq.nextval,?)");
