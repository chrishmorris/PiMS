...
public class TargetServiceImpl extends BaseServiceImpl  implements TargetService {
    ...
    public Target find(long id) throws BusinessException {
    	return this.find(org.pimslims.model.target.Target.class.getName() + ":" + id);
    }
    ...
    public Collection<Construct> getConstructs(Target target, BusinessCriteria criteria) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    static Target getXtalTarget(ReadableVersion version, String name) {
        ...
        if (null==pimsTarget) {return null;}
