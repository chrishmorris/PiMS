...
public class ProjectServiceImpl extends BaseServiceImpl implements ProjectService {
    ...
    public Project find(long id) throws BusinessException {
        return this.find(org.pimslims.model.target.Project.class.getName() + ":" + id);
    }

    public Project find(String id) throws BusinessException {
        return getXtalProject((org.pimslims.model.target.Project) version.get(id));
    }
    ...
    public Collection<Sample> getSamples(Project project, BusinessCriteria criteria) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Collection<Project> findByOwner(Person person, BusinessCriteria criteria) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Collection<Project> findByOwner(String username, BusinessCriteria criteria) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Collection<Project> findByLocalContact(Person person, BusinessCriteria criteria)
        throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Collection<Project> findByLocalContact(String username, BusinessCriteria criteria)
        throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    public Collection<Project> findByGroup(Group group, BusinessCriteria criteria) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Collection<Project> findByPlate(TrialPlate plate, BusinessCriteria criteria) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Collection<Project> findByPlate(String barcode, BusinessCriteria criteria) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }

    public Project findByPlate(PlateExperimentView plateExperiment) throws BusinessException {
        throw new UnsupportedOperationException("Not supported yet.");
    }
    ...
    public void create(Project project) throws BusinessException {
        try {
            org.pimslims.model.target.Project pimsTargetProject =
                new org.pimslims.model.target.Project((WritableVersion) version, project.getName(),
                    project.getName());
            project.setId(pimsTargetProject.getDbId());

            // Set targets
            List<org.pimslims.model.target.Target> pimsTargets =
                new LinkedList<org.pimslims.model.target.Target>();
            for (Target xTarget : project.getTargets()) {
                org.pimslims.model.target.Target pimsTarget =
                    version.findFirst(org.pimslims.model.target.Target.class,
                        org.pimslims.model.target.Target.PROP_NAME, xTarget.getName());
            ...
            // TODO where we can store project.getDescription() ????
     ...
     * @throws BusinessException
     */
    protected Project getXtalProject(ReadableVersion version, String name) throws BusinessException {
        org.pimslims.model.target.Project pimsTargetProject =
            version.findFirst(org.pimslims.model.target.Project.class,
     ...
     * @throws BusinessException
     */
    protected Project getXtalProject(org.pimslims.model.target.Project pimsTargetProject)
        throws BusinessException {
        ...
        //Permission permission=access.findFirst(AccessObject.PROP_PERMISSIONS, Permission.PROP_OPTYPE, "create");
/*        TODO the group does not work in this way, need reimplement!
        org.pimslims.model.people.Person pimsPerson =
            PersonDAO.getpimsPerson(version, pimsTargetProject.get_Owner());
        if (null != pimsPerson) {
            org.pimslims.model.people.Group pimsGroup = pimsPerson.getCurrentGroup();
            if (null != pimsGroup) {
        ...
        // Set the owner
        Person owner = personService.findByUsername(pimsTargetProject.get_Owner());
        if (null != owner) {
