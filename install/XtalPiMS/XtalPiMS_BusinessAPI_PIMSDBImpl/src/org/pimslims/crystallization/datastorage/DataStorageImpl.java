...
public class DataStorageImpl implements DataStorage {
	...
	/**
	 * <p>
	 * This function will completely close any connections that have been
	 * created to data stores such as databases or files.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * This will close any resources that have been opened, however this does
	 * not include the termination of a connection (to say a database), to do
	 * this use the terminateResources function
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * This function will open any resources that will be used to store or
	 * retrieve data from a data source.
	 * </p>
	 * <p>
	 * This may include opening a connection to that resource if it has not
	 * already been done
	 * </p>
	 * 
	 * @param username
	...
	public void openResources(final String username) throws BusinessException {
		...
		if (version != null) {
			...
			final StackTraceElement[] trace = ((ReadableVersionImpl) version)
					.getStackTrace();
	...
	public void openResources(final String username, final boolean canReadAll,
			final boolean canWriteAll) throws BusinessException {
