...
/**
 * <p>
 * Data Access Object for {@link org.pimslims.business.crystallization.model.Image}
 * </p>
 * 
 * @author Bill Lin
 */
public class ImageDAO extends GenericDAO<Image, org.pimslims.business.crystallization.model.Image> {
    ...
    protected void createPORelated(final Image pobject,
        final org.pimslims.business.crystallization.model.Image xobject) throws ConstraintException,
    ...
    @Override
    protected org.pimslims.business.crystallization.model.Image loadXAttribute(final Image pobject)
        throws BusinessException {
        final org.pimslims.business.crystallization.model.Image xImage =
            new org.pimslims.business.crystallization.model.Image();
    ...
    protected org.pimslims.business.crystallization.model.Image loadXRole(
        final org.pimslims.business.crystallization.model.Image xobject, final Image pobject)
        throws BusinessException {
        return xobject;
    }
    ...
    protected void updatePORelated(final Image pobject,
        final org.pimslims.business.crystallization.model.Image xobject) throws ModelException {
    ...
    public static String getPath(final String imagePath) {
        String ret = imagePath.substring(0, imagePath.length() - getName(imagePath).length());
