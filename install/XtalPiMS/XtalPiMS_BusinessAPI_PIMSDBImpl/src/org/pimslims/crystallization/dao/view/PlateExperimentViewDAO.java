 ...
 * 
 */
public class PlateExperimentViewDAO extends AbstractSQLViewDAO<PlateExperimentView> implements
    ViewDAO<PlateExperimentView>, PropertyNameConvertor<PlateExperimentView> {
    ...
    public String convertPropertyName(final String propertyName) throws BusinessException {
        ...
        } else if (propertyName.equals(PlateExperimentView.PROP_LAST_IMAGE_DATE)) {
            return "lastinpsection.completiontime";
        } else if (propertyName.equals(PlateExperimentView.PROP_NUMBER_OF_CRYSTALS)) {
    ...
    public String getViewSql(final BusinessCriteria criteria) {
        ...
        return buildViewQuerySQL(criteria, selectHQL, null, "plate_2", Holder.class);
    }
     ...
     */
    @Override
    Collection<PlateExperimentView> runSearch(final org.hibernate.SQLQuery sqlQuery) {
        ...
        q.addScalar("owner", StandardBasicTypes.STRING);
        q.addScalar("runBy", StandardBasicTypes.STRING);
        q.addScalar("group", StandardBasicTypes.STRING);
        q.addScalar("status", StandardBasicTypes.STRING);
        q.addScalar("lastimagedate", StandardBasicTypes.CALENDAR);
        q.addScalar("imager", StandardBasicTypes.STRING);
        q.addScalar("temperature", StandardBasicTypes.FLOAT);
        q.addScalar("numberofcrystals", StandardBasicTypes.LONG);
        q.addScalar("platetype", StandardBasicTypes.STRING);
        q.addScalar("screen", StandardBasicTypes.STRING);
        q.addScalar("proteinsampleid", StandardBasicTypes.LONG);
        q.addScalar("proteinsamplename", StandardBasicTypes.STRING); */
