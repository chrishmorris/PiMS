...
public class OrderXmlLoader extends XmlLoader {
     ...
     */
    public OrderXmlLoader(InputStream input, DataStorage ds) throws BusinessException {
    ...
    /**
     * ExperimentXmlLoader.getPlateOrder
     * 
     * @param input
    ...
    public Collection<TrialPlate> getTrialPlates() throws BusinessException {
        ...
        for (Iterator<Element> iterator = this.getChildrenIterator(screenOrders, "screen"); iterator
            .hasNext();) {
        ...
        // process sample info
        setExperimentDetails(getChildElement(this.document, "experimentInfo"), ret);
        return ret;
    }
     ...
     * @param childElement
     */
    private void setExperimentDetails(Element info, Collection<TrialPlate> plates) {
        ...
        for (Node sample = samples.getFirstChild(); sample != null; sample = sample.getNextSibling()) {
            ...
            final SampleQuantity sampleQuantity = new SampleQuantity(bean, volume / 1000000, "L");
