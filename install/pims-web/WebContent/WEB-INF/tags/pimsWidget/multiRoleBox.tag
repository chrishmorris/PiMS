...
<c:set var="queryString"></c:set>
    <c:if test="${mayAdd}">
        <a onclick="startMultiRoleEdit(this,'${pageContext.request.contextPath}/EditRole/${objectHook}/${roleName}?isInModalWindow=true');return false;" href="${pageContext.request.contextPath}/EditRole/${objectHook}/${roleName}">Search/Add</a>
...
<pimsWidget:box title="${title}" 
    src="/read/ListRole/${objectHook}/${roleName}?${queryString}" 
