...
<div class="functionblocks">
    ...
    <pimsWidget:box initialState="fixed" title="Reference Data">
      <ul>
        ...
        <li><h4>Database Names:</h4>
            <a href="${pageContext.request['contextPath']}/Search/org.pimslims.model.reference.DbName">Search</a> <img src="${pageContext.request['contextPath']}/skins/default/images/pinkcarrot.png" alt="">
            <c:choose>
              <c:when test="${isAdmin}">
                <a href="${pageContext.request['contextPath']}/Create/org.pimslims.model.reference.DbName">New</a>
              </c:when>
              <c:otherwise><p>New</p></c:otherwise>
            </c:choose>
         </li>
  ...
  <%-- Center column of blocks --%>
    ...
    <ul>
      ...
      <li><a href="${pageContext.request.contextPath}/Search/org.pimslims.model.molecule.Molecule?molType=protein">Search Protein</a> <img src="${pageContext.request['contextPath']}/skins/default/images/pinkcarrot.png" alt="">   
