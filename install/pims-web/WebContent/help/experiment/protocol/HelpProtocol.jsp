...
<div class="helpcontents">
 ...
 <h3 id="parameters">Defining Parameters</h3>
 <div class="textNoFloat">
 <p>Protocol parameters are used to describe any values you wish to record in Experiments
 based on this protocol. They are of three types:<ul>
   <li>Result parameters are used record observations.</li>
   <li>Set up parameters record decisions about details of the protocol followed, e.g. buffer used.</li>
   <li>Group level parameters record decisions which apply to a whole group of experiments which are done together,
   e.g. whether to shake a plate.</li>
 </ul></p>
 ...
 in the Parameters box:</p>
  ...
  <h4>Automatic propagation of values</h4>
  
  <p>PiMS can carry forward a value from a previous experiment, e.g. the molecular weight of your protein. 
  When you record the use of an input sample, it automatically looks at the experiment
  which produced the sample. It then copies the value of any parameter that passes these tests:
  <ul>
    <li>It is a set up parameter in the new protocol </li>
    <li>No value has been recorded for the parameter</li>
    <li>In particular, no default value is defined in the protocol</li>
    <li>The previous protocol has a parameter with the same name</li>
  </ul></p>
