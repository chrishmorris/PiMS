...
<h4 id="expParams">Setup and Results</h4>
  ...
  You may define any number of Parameters for a protocol in PiMS.
  </p>
  The example shows the &#39;Parameters&#39; box for an experiment using the default
  PiMS PCR protocol.<br />
  The names of the Parameters are on the left and the values,
  ...
  <ul>
   ...
   <li>If appropriate, PiMS will propagate the value from a previous experiment.</li>
  </ul><br />
