...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
    ...
    <table>
        ...
        <c:forEach var="parm" items="${protocol.parameterDefinitions}" varStatus="status" >
            ...
            <tr id="${parm.hook}" class="ajax_deletable">
                <td> 
                  <c:if test="${!status.first }">
                    <img  src="${pageContext.request.contextPath}/skins/default/images/icons/actions/moveup.gif" 
    			 	  alt="Move up" 
    			 	  onclick="reorderDown('${prev.hook}')" />
                  </c:if>
                  &nbsp;
                  <c:if test="${!status.last }">
                    <img  src="${pageContext.request.contextPath}/skins/default/images/icons/actions/movedown.gif" 
    			 	  alt="Move down" 
    			 	  onclick="reorderDown('${parm.hook}')" />
                    <c:set var="prev" value="${parm }" />
                  </c:if>
                </td>
                ...
                <c:if test="${mayUpdate}">
                    ...
                    <a href="#">
                        <img src="${pageContext.request.contextPath}/skins/default/images/icons/actions/edit.gif" 
                          ...
                          onclick="openModalWindow('${pageContext.request.contextPath}/EditParameterDefinition/${parm.hook}','Edit parameter: <c:out value="${parm.name}" />');return false;"
                        />
                    </a>
                    </td>                
                    <td style="width:40px;" class="noprint">
