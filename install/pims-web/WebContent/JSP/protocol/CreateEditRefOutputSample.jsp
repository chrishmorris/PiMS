...
<jsp:include page="/JSP/core/Header.jsp">
    <jsp:param name="HeaderName" value='Details of an output' />
    <jsp:param name="isInModalWindow" value='yes' />
</jsp:include>
<!-- CreateEditRefOutputSample.jsp -->
...
<c:choose><c:when test="${!empty bean}">
	...
	<c:set var="hook">org.pimslims.model.protocol.RefOutputSample</c:set>
	<c:set var="buttonLabel">Create</c:set>
	<c:set var="formAction">/Create/org.pimslims.model.protocol.RefOutputSample</c:set>
