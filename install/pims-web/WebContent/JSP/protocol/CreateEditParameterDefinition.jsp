...
<pimsForm:form action="#" mode="edit" method="post" id="dummyform">
    <pimsForm:formBlock>
        <pimsForm:column1>
            ...
            </c:if><%--TODO use pimsForm:boolean --%>
            <pimsForm:radio name="isMandatory" alias="Mandatory parameter" value="yes" label="Yes" isChecked="${pdef.isMandatory }"/>
            <pimsForm:radio name="isMandatory" alias="" value="no" label="No" isChecked="${!pdef.isMandatory }"/>
        </pimsForm:column1>
        <pimsForm:column2>
    ...
    <c:choose><c:when test="${'Boolean'==paramType}">
        ...
        <pimsForm:formBlock>
            <pimsForm:column1>
	            ...
	            <pimsForm:radio name="def" alias="" value="no" label="No" isChecked="no"/><%--TODO use pimsForm:boolean --%>
            </pimsForm:column1>        
        </pimsForm:formBlock>
