...
<c:if test="${empty param['isInModalWindow'] &&!_MHTML}">
	<div class="noprint main_footer">
		<div style="color:#006;width:29em;text-align:left;margin:0 auto">
		<img style="float:left;position:relative;top:-0.25em" src="${pageContext.request.contextPath}/${PIMS_DISTRIBUTION }/footer_logo.png" />
