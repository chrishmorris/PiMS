...
<pimsWidget:box title="Plasmid stocks" initialState="open">
  <display:table class="list" id="mytable" name="${psBeans}"
    ...
    <display:column title="Stock name" escapeXml="false"  style="padding:2px 4px 0 3px;width:20px;" media="html"   >
        <pimsWidget:link bean="${mytable}"/>
     </display:column>
    <display:column  title="Stock name" escapeXml="true" media="xml excel csv"   property="stockName" />

    <display:column escapeXml="false" title="Box"   media="html" >
    ...
    <display:column escapeXml="true" title="Box" media="xml excel csv"   property="rack" />

     <display:column escapeXml="true" title="Position" property="rackPosition"   />

        <pimsWidget:dateLink date="${mytable.experimentDate}"  />
     </display:column>
    <display:column escapeXml="true" title="Date" media="xml excel csv"   property="dateAsString" />
    ...
    <display:column escapeXml="true"   title="Conc. (&#181;g/&#181;L)" property="concentration" media="html" />
    <display:column escapeXml="true"   title="Conc. (ug/uL)" property="concentration" media="xml excel csv" />

     <display:column escapeXml="true" title="Description" property="description" maxLength="100" />
     <display:column escapeXml="true" title="Antibiotic Resistance" property="antibioticRes"   style="width:8em;" headerClass="sortable" />
     <display:column escapeXml="true" title="Strain" property="strainPrepdFrom"   />
     ...
     <display:column escapeXml="true" title="Stored by" property="initials"   />
