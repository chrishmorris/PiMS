...
<pimsWidget:box title="Cell stocks" initialState="open">
  <display:table class="list" id="mytable" name="${csBeans}"
    ...
    <display:column escapeXml="false"  style="padding:2px 4px 0 3px;width:20px;" media="html"   title="Stock name" >
        <pimsWidget:link bean="${mytable}"/>
     </display:column>
    <display:column escapeXml="true"  style="padding:2px 4px 0 3px;width:20px;" media="xml excel csv"   title="Stock name" property="stockName" />

     <display:column escapeXml="false" title="Box" style="width:20px;" media="html"   >
     ...
     <display:column escapeXml="true" media="xml excel csv"   title="Box" property="rack" />

     <display:column escapeXml="true" title="Position" style="width:10px;" property="rackPosition"   />

        <pimsWidget:dateLink date="${mytable.experimentDate}"  />
     </display:column>
     <display:column escapeXml="true" media="xml excel csv"   title="Date" property="dateAsString" />

     <display:column escapeXml="true" title="Description" property="description" maxLength="100" />
     <display:column escapeXml="true" title="Strain"  property="strain"   headerClass="details" maxLength="100" />
     <display:column escapeXml="true" title="Antibiotic Resistance" property="hostAbRes"   />

     <display:column escapeXml="false" title="Plasmid"   media="html" >
     ...
     <display:column escapeXml="true" title="Plasmid" media="xml excel csv" property="plasmid"   />

     <display:column escapeXml="false"   title="Vector" media="html" >
     ...
     <display:column escapeXml="true" title="Vector" media="xml excel csv" property="vector"   />

     <display:column escapeXml="true"  property="initials"   title="Stored by"/>
