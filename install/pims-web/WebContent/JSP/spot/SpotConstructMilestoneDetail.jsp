...
<jsp:include page="/JSP/core/Header.jsp">
    <jsp:param name="HeaderName" value='PiMS Milestone: ${spotTarget.proteinName} ${spotConstructMilestone.milestoneName} ' />
...
: <a href="${pageContext.request.contextPath}/View/${targetBean.hook}">Target <c:out value="${targetBean.proteinName}" /></a>
</c:if>
