<%--
PrimerList.JSP
Included in SpotNewConstructWizardStep2choice.jsp which is called by 
org.pimslims.servlet.spot.SpotNewConstructWizard
Displays a list of forward and reverse primers plus length and Tm from r and 
