...
<!-- search/org.pimslims.model.protocol.Protocol.jsp  -->
<c:catch var="error">
...
<jsp:useBean id="instrumentTypes" scope="request" type="java.util.Collection<org.pimslims.presentation.ModelObjectShortBean>" />
	...
	<pimsForm:form mode="edit" method="get" action="/Search/org.pimslims.model.protocol.Protocol">
		...
		<pimsForm:formBlock>
			<pimsForm:column1>
				...
				<c:set var="product" value="<%= org.pimslims.servlet.protocol.SearchProtocol.PRODUCT %>" />
				<pimsForm:selectMultiple  alias="Product" name="${product }" 
					   helpText="Category of output sample produced"
					   selected="${paramValues[product] }"
