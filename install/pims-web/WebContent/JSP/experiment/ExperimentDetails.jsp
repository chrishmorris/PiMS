...
function showSampleSearch(elem,sampleDefID,sampleCategory) {
    ...
    mruToUpdate=elem;
    openModalWindow(contextPath+"/Search/org.pimslims.model.sample.Sample?isInModalWindow=yes&<%= org.pimslims.servlet.QuickSearch.CALLBACK_FUNCTION %>=chooseSample&sampleCategories="+sampleCategory,"Choose sample");
}
