...
<!-- dnatarget/DNAConstructDetail.jsp -->
...
<pimsWidget:box title="Predicted PCR Product" initialState="closed" id="product" >    
    ...
    <pimsForm:dna name="${constructBean.pcrProductSeqHook}" alias="DNA sequence"  helpText="The DNA sequence of the predicted PCR product" value="${constructBean.pcrProductSeq}" />
