...
Author: cm65
Date: 3 Mar 2010
TODO if this is MHTML report, can we include them? See MhtmlFilter.
--%>
...
<tr id="${file.hook}" class="ajax_deletable">
    ...
    <td>
        <a onclick='return warnChange()' href="${pageContext.request['contextPath']}/ViewFile/${file.hook}/<c:out value="${file.name}" />" title="view file" >
