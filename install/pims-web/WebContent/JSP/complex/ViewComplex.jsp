...
<c:set var="boxHeader" scope="page">
    <c:if test="${mayAdd}">
        <a onclick="startMultiRoleEdit(this,'${pageContext.request.contextPath}/update/EditComplexRole/${complexbean.blueprintHook}/researchObjectiveElements?isInModalWindow=true&componentType=target');return false;" 
...
<pimsWidget:box title="Components" 
    src="/read/ListRole/${complexbean.blueprintHook}/researchObjectiveElements" 
