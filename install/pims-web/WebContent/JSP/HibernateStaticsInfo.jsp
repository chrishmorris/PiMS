...
<jsp:include page="/JSP/core/Header.jsp">
	<jsp:param name="HeaderName" value="Hibernate Statistic Information" />
</jsp:include>
...
<form method="POST" action="${pageContext.request.contextPath}/JSP/HibernateStaticsInfo.jsp" class="singlebutton cancel">
