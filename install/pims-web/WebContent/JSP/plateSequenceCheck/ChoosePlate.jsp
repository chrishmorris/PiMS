...
<br/><a href="${pageContext.request.contextPath}/ViewFile/${seqloader.collatedFileHook}/sequences.txt">Collated file</a>
<br/><a href="${pageContext.request.contextPath}/ViewFile/${seqloader.originalFileHook}/osequences.zip">Original file</a>
</p>
