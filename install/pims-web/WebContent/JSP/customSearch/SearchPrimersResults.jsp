...
suspected obsolete
 <display:table class="list" id="mytable" name="${results}"  sort="list" pagesize="${pagesize}" >
   	...
   	<display:column escapeXml="false"  style="padding:2px 0 0 3px; white-space: nowrap; width:20px; " media="html" title="" >
		...
		<display:column title="Position" property="position" escapeXml="true"   />

		<display:column media="html" title="Cloning Design Experiment"   >
		...
		<display:column media="excel csv xml" title="Cloning Design Experiment"   >
