...
<%-- If there is no MolComponent DNA --%>
    ...
    <pimsForm:dna name="${psgb.sgDnaSeqHook}:${Molecule['PROP_SEQSTRING'] }" alias="DNA sequence"  helpText="The DNA sequence " value="${psgb.dnaSeq}" />
...
<pimsForm:formBlock id="blk3">
    ...
    <pimsForm:protein name="${psgb.sgProteinSeqHook}:${Molecule['PROP_SEQSTRING'] }" alias="Protein sequence" helpText="The Protein sequence of the Synthetic gene"
    value="${psgb.proteinSeq}" />
