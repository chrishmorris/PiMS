...
<pimsWidget:multiRoleBox objectHook="${hook}" roleName="targets" title="Search/Add targets" />
   ...
   <c:otherwise>
    ...
    <display:column title="Name" escapeXml="false" style="padding:2px 0 0 3px;width:20px;" media="html"    >
        <pimsWidget:link bean="${mytable}"/>
    </display:column>
    <display:column  title="Name" escapeXml="true" media="xml excel csv"   property="commonName" />
    <display:column escapeXml="true"  property="proteinName"   title="Protein name" />
    ...
    <display:column escapeXml="true"  property="whyChosen" headerClass="details" maxLength="100" title="Comments" />     <display:column escapeXml="true"  property="projectList"   maxWords="3" title="Lab Notebook" />
    <display:column escapeXml="true"  property="status"  />
    <display:column escapeXml="true"  property="statusDate" title="Status date" media="html"   decorator="org.pimslims.servlet.utils.decorators.Date" />
...
<form action="${pageContext.request.contextPath}/report/TargetsReportAction" method="get"  style="background-color: transparent; width: auto;">
  ...
  <display:table class="list" id="row" name="${requestScope.targets}" 
     ...
     <display:column escapeXml="false"  property="link"   media="html" />
     <display:column escapeXml="true"  property="commonName"   title="Name"/>
     <display:column escapeXml="true"  property="proteinName"   title="Protein name" />
     <display:column escapeXml="true"  property="aliases" title="Aliases" />
