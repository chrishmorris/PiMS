 ...
 * - used for persistence of tab ID suspected obsolete
 */
function tab_appendTabIdToForm(frm,tabId){
	alert("suspected obsolete");
  if(!frm["_tab"]){
...
//furthermodification for user-entered DNA sequences for New Extension in SpotNewConstructWizardStep3c -doesn't use widgets
