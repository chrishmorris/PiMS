...
public class ProtocolBean extends ModelObjectBean {
    ...
    private final List<RefInputSampleBean> reagents;
    ...
    public ProtocolBean(final Protocol protocol) {
        ...
        this.reagents = new ArrayList<RefInputSampleBean>(protocol.getRefInputSamples().size());
        ...
        for (final Iterator iter = protocol.getRefInputSamples().iterator(); iter.hasNext();) {
            ...
            if (null == ris.getRecipe()) {
                ...
                this.reagents.add(new RefInputSampleBean(ris));
            }
        }
        ...
        //no, used saved order Collections.sort(this.parameters);
        ...
        //no, used saved order Collections.sort(this.setupParameters);
        ...
        //no, used saved order Collections.sort(this.resultParameters);
    ...
    /**
     * ProtocolBean.getReagents
     * 
     * @return
     */

    public List<RefInputSampleBean> getReagents() {
        return new ArrayList(this.reagents);
    }
