...
public class ExperimentReader {
    ...
    /**
     * ParameterDefinitionOrder
     * 
     */
    public static final class ParameterDefinitionOrder implements Comparator<Parameter> {

        private final List<ParameterDefinition> parameterDefinitions;

        /**
         * Constructor for ParameterDefinitionOrder
         * 
         * @param protocol
         */
        public ParameterDefinitionOrder(final Protocol protocol) {
            this.parameterDefinitions = protocol.getParameterDefinitions();
        }

        /**
         * Comparator<Parameter>.compare
         * 
         * @see java.util.Comparator#compare(java.lang.Object, java.lang.Object)
         */
        @Override
        public int compare(final Parameter o1, final Parameter o2) {
            final ParameterDefinition pd1 = o1.getParameterDefinition();
            final ParameterDefinition pd2 = o2.getParameterDefinition();
            if (null == pd1 || null == pd2) {
                return 0;
            }
            final Integer index1 = this.parameterDefinitions.indexOf(pd1);
            final Integer index2 = this.parameterDefinitions.indexOf(pd2);
    ...
    */
    ...
    @Deprecated
    // use ExperimentBean.getOutputSampleBeans
    ...
    public static List<Parameter> getParameters(final Experiment experiment) {
        ...
        if (null == experiment.getProtocol()) {
            ...
            Collections.sort(parameters, new ParameterDefinitionOrder(experiment.getProtocol()));
        }
        return parameters;
    }
}
