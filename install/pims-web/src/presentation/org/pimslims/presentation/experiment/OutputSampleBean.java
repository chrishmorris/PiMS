...
// TODO make this a subclass of ModelObjectBean
public class OutputSampleBean {
    ...
    private final ModelObjectShortBean sampleBean;
    ...
    public OutputSampleBean(final OutputSample outputSample) {
        ...
        //was assert (null != sample);
        if (null == sample) {
            this.sampleBean = null;
        } else {
            this.sampleBean = new ModelObjectShortBean(sample);
        ...
        if (null == category && null != sample && 1 == sample.getSampleCategories().size()) {
            category = sample.getSampleCategories().iterator().next();
        }
        if (null == category) {
    ...
    /**
     * @return Returns the sampleBean.
     */
    public ModelObjectShortBean getSampleBean() {
