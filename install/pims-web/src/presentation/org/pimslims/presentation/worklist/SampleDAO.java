...
public class SampleDAO {
    ...
    static List<Sample> getNoProgressSamples(final ReadableVersion rv, final int daysNoProgress,
        ...
        // speedupQuery(rv,isReadyForNext,alreadyInUse,active,userHookAssignedTo);
    ...
    static String getSampleQuery(final Boolean isReadyForNext, final String endDateTag,
        ...
        // where conditines
        final String whereString = JpqlQuery.getWhereHQL(version, "sample", conditions, Sample.class);
        // final query string
