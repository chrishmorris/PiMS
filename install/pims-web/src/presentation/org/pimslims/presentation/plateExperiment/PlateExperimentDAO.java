...
/*
    ...
    public static int getTotalPlateExperimentCount(final ReadableVersion rv) {
        ...
        final String whereString =
            JpqlQuery.getWhereHQL(rv, "exp.experimentGroup", PlateExperimentDAO.getConditions(criteria),
     ...
     * 
     *            String whereString = JpqlQuery.getWhereHQL(rv, "exp.experimentGroup",
    ...
    private static int countExpGroup(final ReadableVersion rv, final PlateCriteria criteria) {
        ...
        final String whereString =
            JpqlQuery.getWhereHQL(rv, "expGroup", PlateExperimentDAO.getConditions(criteria),
                ExperimentGroup.class);
