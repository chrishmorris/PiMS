...
public class DayBean {
    ...
    public static DayBean resort(final Collection<LabBookEntry> labBookEntries, final Calendar day) {
        ...
        final SimpleDateFormat df = new SimpleDateFormat(Utils.day_date_month_format); //TODO think about this
        dayBean.setFormattedDate(df.format(day.getTime()));

        final SimpleDateFormat ldf = new SimpleDateFormat(Utils.link_date_format); //TODO think about this
