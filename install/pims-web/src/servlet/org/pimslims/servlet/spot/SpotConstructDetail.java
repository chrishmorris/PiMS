...
//TODO @WebServlet("/read/ConstructView/*")
...
/* common servlet that provides utility methods */PIMSServlet {
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("experimentMetaClass", this.getModel().getMetaClass(
            ...
            if (tb.isDNATarget()) {
                ...
                final RequestDispatcher dispatcher =
                    request.getRequestDispatcher("/JSP/spot/SpotConstructDetail.jsp");
                dispatcher.forward(request, response);
            }
