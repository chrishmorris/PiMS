...
public class SpotNewTarget extends PIMSServlet {
     ...
     */
    @Deprecated
    // involves information disclosure
    public static void setPeople(final HttpServletRequest request, final ReadableVersion version)
        throws ServletException {
        request.setAttribute("people", Collections.EMPTY_SET);
        final User person = PIMSServlet.getCurrentUser(version, request);
        if (null != person) {
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            tb.setUserHook(request.getParameter("personHook")); //TODO no 
