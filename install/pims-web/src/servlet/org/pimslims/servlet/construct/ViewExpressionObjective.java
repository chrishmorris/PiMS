...
// TODO @WebServlet("/read/ViewExpressionObjective/*")
        ...
        try {
            ...
            if (ComplexBeanReader.isComplex(ro)) {
                final RequestDispatcher rd =
                    request.getRequestDispatcher("/read/ViewComplex/" + ro.get_Hook());
...
/*
            ...
            version.commit();
            //TODO request.setAttribute("mayUpdate", new Boolean(PIMSServlet.mayUpdate(request)));
