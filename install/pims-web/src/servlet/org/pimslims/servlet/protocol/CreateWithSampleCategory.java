    ...
    public void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            if (null == request.getParameter("recipe")) {
                ...
                final RefSample recipe = version.get(request.getParameter("recipe"));
                if (null == recipe) {
                    throw new ServletException("Recipe not found: " + request.getParameter("recipe"));
                }
                request.setAttribute("sampleCategories",
                    ModelObjectShortBean.getModelObjectShortBeans(recipe.getSampleCategories()));
                request.setAttribute("recipe", new ModelObjectShortBean(recipe));
            }
