...
public class CreateProtocol extends Create {
     ...
     * _COPY_OF String 
     */
    public static final String _COPY_OF = "_copyOf";
    ...
    private void experimentTypePrompt(final ReadableVersion version, final HttpServletRequest request,
        ...
        final String hook = request.getParameter(_COPY_OF);
        if (null != hook) {
            final ModelObject toCopy = version.get(hook);
            request.setAttribute("bean", new ModelObjectShortBean(toCopy));
        }
