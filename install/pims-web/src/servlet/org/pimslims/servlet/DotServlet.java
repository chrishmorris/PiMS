...
public class DotServlet extends PIMSServlet {
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            final String imagePath =
                sb.substring(0, sb.indexOf(request.getRequestURI())) + request.getContextPath()
                    + "/skins/default/icons/types/small/";
            final String data =
                DotServlet.generateGraphModelAndInput(object, imagePath, AbstractGraphModel.MAX_NODES, width,
                    height);
            ...
            final byte[] graph =
                new DotGraphUtil()
                    .runDot(org.pimslims.properties.PropertyGetter.getStringProperty("dot_path", "dot"),
                        format, data);
            ...
            if ("png".equals(format)) {
                ...
                String toPrint = new String(graph, "UTF-8");
                if ("cmapx".equals(format)) {
                    // for including cmapx in page
                    final String map2 = toPrint.replace("\\\\&#39;", "\\'");
                    toPrint = map2.replace("&#39;", "'");
                }
     ...
     * @return
     */
    public static String generateGraphModelAndInput(final ModelObject object, final String imagePath,
        ...
        // could pass imagepath, but GraphViz ignores it for served SVG
