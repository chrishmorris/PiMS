...
public class ReportExperimentParameters extends PIMSServlet {
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            final Collection<ExperimentBean> beans =
            ...
            for (final ExperimentBean bean : beans) {
    ...
    static Collection<ExperimentBean> getExperimentParameters(final Collection<String> expHooks,
        final Collection<String> expGroupHooks, final ReadableVersion version) {
        final Collection<ExperimentBean> beans = new LinkedList<ExperimentBean>();
        // get ExperimentParameterBean from experiment
        for (final String hook : expHooks) {
            final Experiment exp = version.get(hook);
            beans.add(new ExperimentBean(exp));
        }
