...
public class Copy extends PIMSServlet {
    ...
    protected void doPost(final HttpServletRequest request, final HttpServletResponse response)
        ...
        final String book = request.getParameter("_OWNER");
        if (null != book) {
            rw.setDefaultOwner(book);
        }
        ...
        try {
            ...
            } else if (hook.startsWith(Location.class.getName())) {
                rw.setDefaultOwner(rw.getFirstProject()); //TODO copy must prompt for project
                duplicate = LocationUtility.duplicate((Location) object, rw);
                // This is a safe cast the hook is verified above
            } else {
