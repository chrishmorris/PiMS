...
import org.pimslims.persistence.HqlQuery;
    ...
    static void searchScores(final ReadableVersion version,
        ...
        //historicalScores
        {
            ...
            final String whereString =
                HqlQuery.getWhereHQL(version, "milestone", conditions, Milestone.class);
        ...
        //currentScores
        {
            ...
            final String whereString = HqlQuery.getWhereHQL(version, "target", conditions, Target.class);
            final String groupBy = " group by status.name ";
            final String selectHQL =
