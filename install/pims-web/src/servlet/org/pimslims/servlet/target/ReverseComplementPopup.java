...
public class ReverseComplementPopup extends org.pimslims.servlet.PIMSServlet implements javax.servlet.Servlet {
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            final int colon2 = hook.indexOf(":", hook.indexOf(":") + 1);
            if (-1 != colon2) { // e.g. /read/ReverseComplementPopup/org.pimslims.model.molecule.Molecule:101207:seqString
                hook = hook.substring(0, colon2);
            }
