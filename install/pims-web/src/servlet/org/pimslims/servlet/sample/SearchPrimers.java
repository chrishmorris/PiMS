...
public class SearchPrimers extends PIMSServlet {
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            ...
            final SearchFilter criteria = QuickSearch.getCriteria(version, metaClass, request.getParameterMap());
            ...
            if (null == request.getQueryString() || "".equals(request.getQueryString())) {
                ...
                QuickSearch.prepareSearchForm(request, version, metaClass, new SearchFilter());
    ...
    Collection<PrimerBean> preparePrimerBeans(final Collection<ModelObject> mObjs) {
        ...
        for (final ModelObject mObj : mObjs) {
            ...
            if (expType.getName().equalsIgnoreCase(org.pimslims.presentation.PrimerBeanWriter.primersDesign)) {
    ...
    static Collection<ModelObject> getResults(final ReadableVersion version, final MetaClass metaClass,
        final SearchFilter criteria, final int pageStart, final int pageSize) throws ServletException, IOException {
        ...
        if (!Util.isEmpty(svalue)) {
            ...
            results = s.search(criteria.getMap(), metaClass);
        }
