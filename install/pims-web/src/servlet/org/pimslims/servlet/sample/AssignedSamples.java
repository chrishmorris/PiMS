 ...
 * 
 */
public class AssignedSamples extends PIMSServlet {

    /**
     * @baseURL /read/WeekOldSamples
     */
    public AssignedSamples() {
        super();
    }
    ...
    public final String getServletInfo() {
        return "samples with no progress brick";
    }
    ...
    protected final void doGet(final HttpServletRequest request, final HttpServletResponse response)
        ...
        try {
            final SampleCriteria assignedSampleCriteria = SampleCriteria.ASSIGNED_SAMPLE_SEARCH;
            if (PIMSServlet.getCurrentUser(version, request) != null) {
                assignedSampleCriteria.setUserHookAssignedTo(PIMSServlet.getCurrentUser(version, request)
                    .get_Hook());
            }
            final List<SampleBean> sampleBeans = SampleDAO.getSampleBeanList(version, assignedSampleCriteria);
