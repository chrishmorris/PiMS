...
public class DivideSample extends PIMSServlet {
    ...
    public static Collection<Sample> divide(final WritableVersion version, final Sample sample,
        ...
        // was attributes.put(Sample.PROP_IMAGES, sample.getImages());
        ...
        //TODO attributes.put(AbstractSample.PROP_SAMPLECATEGORIES, sample.getSampleCategories());
        //TODO attributes.put(AbstractSample.PROP_SAMPLECOMPONENTS, sample.getSampleComponents());
