...
public class PlateReaderTest extends TestCase {
    ...
    public final void testGetExperiments() throws AccessException, ConstraintException {
        ...
        try {
            ...
            this.newOutputSample(version, exp, "");
        ...
        try {
            ...
            final Experiment exp =
                new Experiment(version, "exp1" + PlateReaderTest.UNIQUE, PlateReaderTest.NOW,
                    PlateReaderTest.NOW, type);
            exp.setExperimentGroup(group);
            this.newOutputSample(version, exp, "1").setName("one");
            this.newOutputSample(version, exp, "2").setName("two");
    ...
    public final void testTwoExperiments() throws AccessException, ConstraintException {
        ...
        try {
            ...
            this.newOutputSample(version, exp2, "");
    ...
    /**
     * PlateReaderTest.newOutputSample
     * 
     * @param version
     * @param exp
     * @throws ConstraintException
     */
    private OutputSample newOutputSample(final WritableVersion version, final Experiment exp,
        final String suffix) throws ConstraintException {
        final OutputSample os = new OutputSample(version, exp);
        os.setSample(new Sample(version, exp.getName() + suffix));
        os.setName("out" + suffix);
        return os;
    }
