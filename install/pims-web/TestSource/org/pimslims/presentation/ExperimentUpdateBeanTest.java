...
public class ExperimentUpdateBeanTest extends TestCase {
    ...
    public final void testGetBeans() throws AccessException, ConstraintException {
        ...
        try {
            ...
            this.newOutputSample(version, experiment, "");
    ...
    /**
     * ExperimentUpdateBeanTest.newOutputSample
     * 
     * @param version
     * @param experiment
     * @throws ConstraintException
     */
    private OutputSample newOutputSample(final WritableVersion version, final Experiment experiment,
        final String suffix) throws ConstraintException {
        final OutputSample ret = new OutputSample(version, experiment);
        ret.setSample(new Sample(version, experiment.getName() + suffix));
        return ret;
    }
    ...
    public final void testUpdateOutput() throws AccessException, ConstraintException {
        ...
        try {
            ...
            final Experiment experiment =
                new Experiment(version, ExperimentUpdateBeanTest.UNIQUE, ExperimentUpdateBeanTest.NOW,
                    ExperimentUpdateBeanTest.NOW, type);
            final OutputSample os = this.newOutputSample(version, experiment, "");
