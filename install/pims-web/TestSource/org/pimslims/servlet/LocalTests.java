...
import org.pimslims.servlet.target.SearchTargetTest;
...
public class LocalTests extends junit.framework.TestSuite {
    ...
    public static junit.framework.Test suite() {
        ...
        suite.addTestSuite(BookmarkServletTest.class);
        suite.addTestSuite(CreateMutatedObjectiveTest.class);
        suite.addTestSuite(PdfReportTest.class);
        //TODO suite.addTestSuite(OldSearchTest.class);
        suite.addTestSuite(QuickSearchTest.class);
        suite.addTestSuite(SearchProtocolTest.class);
        ...
        suite.addTestSuite(SearchTargetTest.class);
