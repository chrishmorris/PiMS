...
public class MetaClassImplTester extends TestCase {
    ...
    /*
     * Test method for 'org.pimslims.hibernate.CCPNMetaClass.getParentRole()'
     */
    public final void testGetParentRole() {
        ...
        //m = (MetaClassImpl) model.getMetaClass(AbstractHolder.class.getName());
        //parent = m.getParentRole();
        //assertEquals("project", parent.getRoleName());

        // TODO DM Change 28. ComponentDbRef removed
        // m = (CCPNMetaClass)
        // model.getMetaClass(ComponentDbRef.class.getName());
        // parent = m.getParentRole();
        // assertEquals("component", parent.getRoleName());
    }
