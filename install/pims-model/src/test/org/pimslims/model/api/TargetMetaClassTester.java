...
public class TargetMetaClassTester extends org.pimslims.metamodel.TestAMetaClass {
    ...
    public static final HashMap<String, Object> ATTRIBUTES =
        new HashMap<String, Object>(org.pimslims.test.POJOFactory.getAttrTarget());

    /**
     * Values for creating a protein
     */
    public static final HashMap<String, Object> PROTEIN_ATTRIBUTES =
        new HashMap<String, Object>(org.pimslims.test.POJOFactory.getAttrProtein());
    ...
    public void testStatus() {
        ...
        try {
            ...
            attributes.put(org.pimslims.model.target.Target.PROP_PROTEIN, wv.get(proteinHook));
            Target target = new Target(wv, attributes);
            org.pimslims.test.POJOFactory.createMilestone(wv, target, org.pimslims.test.POJOFactory
                .createStatus(wv, statusName));
    ...
    // TODO model change - write method in LabBookEntry to get external db links
    /*public void doTestTargetDbRef(WritableVersion wv, Target target) throws ConstraintException {
        Map<String, Object> attrDbRef = new HashMap<String, Object>(org.pimslims.utils.POJOFactory.getAttrDbRef());
        org.pimslims.model.dbRef.DbName dbName = org.pimslims.utils.POJOFactory.createDbName(wv);
        attrDbRef.put(org.pimslims.model.core.ExternalDbLink.PROP_DBNAME, dbName);
        attrDbRef.put(org.pimslims.model.core.ExternalDbLink.PROP_TARGETS, Collections.singleton(target));
        new org.pimslims.model.core.ExternalDbLink(wv, attrDbRef);
        assertTrue("target has DbRef", 1 == target.getDbRefs().size());
    }*/
