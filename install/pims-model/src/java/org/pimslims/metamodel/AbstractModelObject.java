...
public abstract class AbstractModelObject implements ModelObject {
    ...
    /*TODO add this example code when ready to change set/get HbXxx to protected
    public static Method[] getAllMethod(Class javaClass) {
        return javaClass.getMethods();
    }
    public static void testProtectedMethod2(ModelObject exp) throws SecurityException, NoSuchMethodException,
        IllegalArgumentException, IllegalAccessException, InvocationTargetException {
        Class javaClass = org.pimslims.model.experiment.Experiment.class;
        java.lang.reflect.Method method =
            javaClass.getSuperclass().getDeclaredMethod("getHbStatus", new Class[] {});
        Attribute annotation = method.getAnnotation(Attribute.class);
        System.out.println(annotation + ":" + annotation.helpText());
        System.out.println("Value="
            + org.pimslims.model.experiment.Experiment.invoke(method, exp, new Object[] {}));
        method = javaClass.getSuperclass().getDeclaredMethod("getHbGroup", new Class[] {});
        Role role = method.getAnnotation(Role.class);
        System.out.println(annotation + ":" + role.helpText());
        System.out.println("Value="
            + org.pimslims.model.experiment.Experiment.invoke(method, exp, new Object[] {}));
    }*/
