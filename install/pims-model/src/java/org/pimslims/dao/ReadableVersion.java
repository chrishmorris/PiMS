...
public interface ReadableVersion extends java.io.Closeable {
    ...
    /**
     * create a query in current readable veriosn
     * 
     * @param targetJavaClass
     * @return the query
     */
    //@Deprecated
    // Use Searcher, or JpqlQuery
    //public PIMSCriteria CreateQuery(Class targetJavaClass, Paging paging);
    ...
    @Deprecated
    public <T extends ModelObject> java.util.Collection<T> findAll(Class<T> javaClass,
        java.util.Map<String, Object> criteria, java.util.List<String> join);
    ...
    /**
     * @return true if the application data is consistent
     */
    @Deprecated
    // never implemented
    ...
    /**
     * Provides a collection of objects with generic methods that can be used to view and manipulate the
     * attributes and associations of objects in the model.
     * 
     * If the collection provided by the caller is a list, then the order will be preserved.
     * 
     * @param specificObjects collection of instance of generated class
     * @return collection of instances of ModelObject
     * 
     * @deprecated now returns the same objects
     */
    @Deprecated
    public <T extends ModelObject> java.util.List<T> getModelObjects(java.util.Collection<T> specificObjects);
    ...
    @Deprecated
    // hibernate specific, use getEntityManager
    ...
    @Deprecated
    // these are now known as lab notebooks
