...
public class VectorXmlConvertor extends XmlConvertor {
    ...
    public static VectorXmlBean convertXmlToVectorBean(final InputStream in) throws JAXBException,
        ...
        return VectorXmlBean.class.cast(XmlConvertor.convertXmlToBean(XmlConvertor.convertStreamToString(in),
            VectorXmlBean.class, VectorXmlConvertor.VECTOR_SCHEMA));
    }
}
