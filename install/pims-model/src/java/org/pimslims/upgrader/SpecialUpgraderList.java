...
public class SpecialUpgraderList {
    ...
    static public abstract class SpecialUpgrader {
        ...
        public void execute() throws SQLException, ConstraintException, AccessException, AbortedException {
            DebugMessageHandler.LOG(MessageHandler.INFO, "(Start-- Special Upgrade Version: " + getVersion());
            upgrade();
            DebugMessageHandler.LOG(MessageHandler.INFO, "Completed-- Special Upgrade Version: "
                + getVersion());
        }
