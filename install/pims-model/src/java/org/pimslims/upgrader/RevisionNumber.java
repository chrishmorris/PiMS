...
public class RevisionNumber {
    ...
    public final static int REVISION = 43; // change this only when release is ready

    private final static String RELEASE = "4_4";

    private final static String TAG = "pims_4_4_43";
