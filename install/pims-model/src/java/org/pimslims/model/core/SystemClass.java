 ...
 * 
 *       TODO reconsider the mappings. The existence of a table doesn't seem to help anything. How does it
...
@org.pimslims.annotation.MetaClass(helpText = "Base class for data model classes. Contains elements common to all classes.", keyNames = {}, subclasses = {
    ...
    org.pimslims.model.accessControl.Permission.class, org.pimslims.model.core.LabNotebook.class })
